			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						...
						return [4 /*yield*/, drawDocument(elemDoc, canvas, { width: width, height: height })];
					case 1:
						_a.sent();
...
var LowLevelElementExporter = /** @class */ (function() {
	function LowLevelElementExporter(element) {
	...
	LowLevelElementExporter.prototype.exportElement = function(exportElementMode) {
		return __awaiter(this, void 0, void 0, function() {
				...
				switch (_a.label) {
					case 0:
						...
						dstWin = window.open(
							'',
							'Export',
							'width=' + dstWinSize.width + ',height=' + dstWinSize.height,
						);
						...
						return [4 /*yield*/, this.dstElemToCanvas(dstElem)];
					case 1:
						dstCanvas = _a.sent();
						// Export
						dstWin.focus();
	...
	LowLevelElementExporter.prototype.getElementWindowSrcForExporting = function(srcElem) {
	...
	LowLevelElementExporter.prototype.computeDstWinSize = function(srcElem) {
	...
	LowLevelElementExporter.prototype.dstElemToCanvas = function(dstElem) {
		return __awaiter(this, void 0, void 0, function() {
	...
	LowLevelElementExporter.prototype.prepareDstDomForExporting = function(dstElem) {
		DOMUtils.addClassToElement(dstElem, this._cssConstants.thisClassName);
		this.hideUnnecessaryElementsForExporting(dstElem);
	};
	LowLevelElementExporter.prototype.hideUnnecessaryElementsForExporting = function(elem) {
	...
	return LowLevelElementExporter;
})();

var ElementExporter = /** @class */ (function() {
	function ElementExporter() {}
	ElementExporter.exportElement = function(element, exportElementMode) {
		return __awaiter(this, void 0, void 0, function() {
			var lowLevelElementExporter, result;
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						lowLevelElementExporter = new LowLevelElementExporter(element);
						return [4 /*yield*/, lowLevelElementExporter.exportElement(exportElementMode)];
					case 1:
						result = _a.sent();
						return [2 /*return*/, result];
				}
	...
	ElementExporter.prototype.printElement = function(element) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, ElementExporter.exportElement(element, ExportElementMode.Print)];
					case 1:
	...
	ElementExporter.prototype.elementToCanvas = function(element) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, ElementExporter.exportElement(element, ExportElementMode.Canvas)];
					case 1:
						return [2 /*return*/, _a.sent()];
				}
			});
	...
	ElementExporter.prototype.elementToPNGImage = function(element) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, ElementExporter.exportElement(element, ExportElementMode.PNGImage)];
					case 1:
						return [2 /*return*/, _a.sent()];
				}
			});
	...
	ElementExporter.prototype.elementToPNGDataUrl = function(element) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, ElementExporter.exportElement(element, ExportElementMode.PNGDataUrl)];
					case 1:
						return [2 /*return*/, _a.sent()];
				}
			});
	...
	ElementExporter.prototype.downloadPNGImageByElement = function(element) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [
							4 /*yield*/,
							ElementExporter.exportElement(element, ExportElementMode.DownloadPNGImage),
						];
					case 1:
						return [2 /*return*/, _a.sent()];
				}
	...
	ElementExporter.prototype.elementToJPGImage = function(element) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, ElementExporter.exportElement(element, ExportElementMode.JPGImage)];
					case 1:
						return [2 /*return*/, _a.sent()];
				}
			});
	...
	ElementExporter.prototype.elementToJPGDataUrl = function(element) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, ElementExporter.exportElement(element, ExportElementMode.JPGDataUrl)];
					case 1:
						return [2 /*return*/, _a.sent()];
				}
			});
	...
	ElementExporter.prototype.downloadJPGImageByElement = function(element) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						return [
							4 /*yield*/,
							ElementExporter.exportElement(element, ExportElementMode.DownloadJPGImage),
						];
					case 1:
						return [2 /*return*/, _a.sent()];
				}
